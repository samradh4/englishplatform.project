...
async function handleRequest(req, res) {
  ...
  if (url.pathname === '/health' && req.method === 'GET') return sendJson(res, 200, { ok: true, version: 20.0, voiceMode: effectiveVoiceMode(), turnConfigured: turnConfigured() });
...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`Bolo English v20 is running at http://localhost:${PORT}`);
